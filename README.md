...
4. Add the page to the site by including it in an `iframe` in [`src/index.html`](https://github.com/maggie-j-liu/story/blob/main/src/index.html). For example, page 1 can be included by adding `<iframe src="/pages/1"></iframe>`.
